...
export default function ContactUs() {
  return (
    <>
      ...
      <div className=" container mx-auto space-y-10 px-1 py-1 xl:max-w-5xl bg-gradient-to-b from-[#ff5722] to-[#ffc507]  mb-4 border-spacing-1 rounded-lg">
        <div className="container mx-auto space-y-10 px-1 py-10  bg-white lg:py-16 xl:max-w-5xl  ">
          {/* Heading */}
          <div className="text-center ">
            <h2 className="mb-3 text-4xl font-black text-black dark:text-white">
          ...
          <div className="border-t-2 border-primaryOrange w ml-0 mr-0 px-0 py-0 lg:px-0 lg:py-0 text-center "></div>
