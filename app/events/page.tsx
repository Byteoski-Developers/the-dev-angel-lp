...
export default function Events() {
  return (
    ...
    <div className="mx-4 md:mx-8 lg:mx-16 xl:mx-20">
      {/* Title */}
      <h3 className="text-center text-gray-600 text-5xl font-bold py-12">Events</h3>
      ...
      <div className="w-full text-center font-poppins px-8 md:px-5 lg:px-16 xl:px-40 mb-8">
        <div className="h-12 px-8 py-2 mb-6 bg-orange-600 bg-opacity-10 rounded-lg flex-col justify-start items-start gap-1.5 inline-flex">
          <div className="justify-start items-end gap-1 inline-flex">
            ...
            <div>
              <div className="text-orange-600 text-xs font-normal inline ">Fill </div>
              <div className="text-orange-600 text-xs font-bold underline inline">this form</div>
